export const metadata = {
  title: "Toasts",
  description:
    "Learn how to build a notification center using Toasts with React, Context API, and react-spring animations. Step-by-step guide with code examples.",
  language: "en",
  date: "2020-04-05",
  excerpt:
